...
const Lnb = ({ active }: Lnb) => {
    return (
        <>
            <div
                className={`hidden sticky top-0 h-[100vh] lg:flex shrink-0 flex-col bg-[var(--moneed-gray-3)] pt-[3.2rem] max-w-[20.8rem] ${
            ...
            >
                ...
                <div className={`shrink-0 pb-[2rem] ${active ? 'block' : 'hidden'}`}>
