...
const Community = () => {
    ...
    const filteredPosts =
        selectedStockType === '전체' ? allPosts : allPosts.filter(post => post.stocktype === selectedStockType);
                    ...
                    {selectedStockType === '전체' ? (
                        <div>
                            ...
                            <div className='bg-[var(--moneed-navy)] h-[12rem] rounded-[.8rem] text-center  pt-[4rem]'>
                                <span className='text-[2rem] leading-[145%] font-[700] text-[var(--moneed-white)]'>
                                    comming soon
                                </span>
                            </div>
